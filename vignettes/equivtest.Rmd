...
For each equivalence test in this package, we have included exerpts of the relevant discussion from the companion paper with a worked through example from *Wellek, S. (2010). Testing statistical hypotheses of equivalence and noninferiority. Chapman and Hall/CRC*. 
